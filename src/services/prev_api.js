...
const update_mock_data = () =>{
  const mock_policy_data = [
    {
      id: 1,
      lastRun: '04/03/2025',
      policyDetails: 'Operational Resilience Framework',
      evaluationComplaint: '1/3',
      evaluationPartiallyComplaint:'1/3',
      evaluationNonComplaint: '1/3'
    },
    {
      id: 2,
      lastRun: '04/03/2025',
  ...
  Object.values(policyAssessmentData.policy_validation).forEach(category => {
    var policy_counts = {"Compliant":0, "Partial Compliance":0, "Non-Compliant":0}
      ...
      i += 1
      console.log(mock_policy_data[i])
  });
...
export const api = {
  ...
  getHome: () => {
    ...
    if (!process.env.REACT_APP_API_URL || process.env.NODE_ENV === 'development') {
      return mockApiCall(update_mock_data());
    }
